...
#
# The command_config provider provides best-effort support for free form style
# configurations. There are limitations with this provider, such as negating
# a non-existent configuration item, e.g. "no interface loopback1" when the
# interface is not currently present in running-config; thus some pre-processing
...
class Chef
  class Provider::CiscoCommandConfig < Provider
