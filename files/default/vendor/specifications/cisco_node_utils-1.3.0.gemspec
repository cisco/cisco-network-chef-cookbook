# -*- encoding: utf-8 -*-
# stub: cisco_node_utils 1.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Rob Gries", "Alex Hunsberger", "Glenn Matthews", "Chris Van Heuveln", "Rich Wellum", "Mike Wiebe", "Jie Yang"]
  s.date = "2016-05-03"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<kwalify>, ["~> 0.7.2"])
